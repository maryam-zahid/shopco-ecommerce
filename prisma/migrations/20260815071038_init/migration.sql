...
-- CreateIndex
CREATE INDEX "DressStyle_isActive_idx" ON "DressStyle"("isActive");
...
-- CreateIndex
CREATE INDEX "Product_dressStyleId_idx" ON "Product"("dressStyleId");
...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_dressStyleId_fkey" FOREIGN KEY ("dressStyleId") REFERENCES "DressStyle"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PaymentAttempt" ADD CONSTRAINT "PaymentAttempt_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
